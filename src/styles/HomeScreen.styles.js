...
const styles = StyleSheet.create({
  ...
  profileSection: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 8, paddingTop: 1, paddingBottom: 12, alignItems: 'center' },
  ...
  idSection: { paddingHorizontal: 0, paddingVertical: 0, marginBottom: 0},
  profileCardWrapper: {
    marginTop: -8,
    backgroundColor: '#ffffff',
    paddingVertical: 8,
  ...
  promoCard: { width: 280, height: 130, backgroundColor: '#FDEAA6', borderRadius: 12, marginRight: 12, padding: 12, overflow: 'hidden', flexDirection: 'row', left: 10 },
  promoLeft: {
    flex: 1,
    borderRadius: 10,
